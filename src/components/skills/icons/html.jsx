  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="Type=Default, showSymbol=True, showText=False">
        <g id="symbol">
          <path id="Shape" fillRule="evenodd" clipRule="evenodd" d="M71.0852 460.819L30 0H481.456L440.327 460.746L255.451 512L71.0852 460.819Z" fill="#E44D26"/>
          <path id="Shape_2" fillRule="evenodd" clipRule="evenodd" d="M255.728 472.824L405.116 431.408L440.263 37.6788H255.728V472.824Z" fill="#F16529"/>
          <g id="Union">
